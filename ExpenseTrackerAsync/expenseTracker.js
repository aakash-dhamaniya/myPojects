...
try{
    const res= await axios.post('https://crudcrud.com/api/cfd916a213544990bbfe634864a2af19/expenses',details)
...
{   try{await axios.delete(`https://crudcrud.com/api/cfd916a213544990bbfe634864a2af19/expenses/${key}`)
...
window.addEventListener('DOMContentLoaded',async()=>{
    const res= await axios.get('https://crudcrud.com/api/cfd916a213544990bbfe634864a2af19/expenses')
     const data= await res.data;
