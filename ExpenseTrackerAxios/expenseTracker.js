...
axios.post('https://crudcrud.com/api/dc1382c25c8f486cb56d8e8d997017ff/expenses',details).then(res=>{
...
{
    axios.delete(`https://crudcrud.com/api/dc1382c25c8f486cb56d8e8d997017ff/expenses/${key}`).then(res=>{
...
window.addEventListener('DOMContentLoaded',()=>{
    axios.get('https://crudcrud.com/api/dc1382c25c8f486cb56d8e8d997017ff/expenses').then(res=>{
