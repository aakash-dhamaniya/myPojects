...
function getTodos() {
  ...
  //   params:{ //it will limit data like if you want to show only 5 data
  //     _limit:5
  //   }
  // }).then(res=>showOutput(res)).catch();
...
// PUT/PATCH REQUEST
//note put will replace whole thing in data and patch will edit only spesific thing
function updateTodo() {
  axios.patch('https://jsonplaceholder.typicode.com/todos/1',{ // this /1 is id of data
    title:'Updated Todo',
    completed:true
  }).then(res=>showOutput(res)).catch(err=>console.log(err))
}
